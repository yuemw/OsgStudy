	...
	: _type(INVALID_OBJ)
{
	...
	osg::ref_ptr<osg::Drawable> quad = osg::createTexturedQuadGeometry(osg::Vec3(-width*0.5f, -height*0.5f, 0.0f),
...
bool GameControllor::handle(const osgGA::GUIEventAdapter& ea,
	osgGA::GUIActionAdapter& aa)
{
